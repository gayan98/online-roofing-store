...
<body class="animsition">
							...
							<table class="table-shopping-cart">
								...
								<?php
									...
									<?php foreach ($_SESSION["cart_item"] as $item) { 
											...
											$total_price = $total_price + ($item["product_price"] * $item["quantity"]);	
											$total_weight = $total_weight + ($item["product_weight"] * $item["quantity"]);
	...
	<!-- Shipping Methods -->
	<form class="bg0 p-t-75 p-b-85"  method ="POST" action="php/reciept.php">
		<div class="container">
			<div class="row">
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								<tr class="table_head">
									...
									<th class="column-5">Rate per Gram</th>
								</tr>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							<input type="hidden" id="subpricehdd" name="subpricehdd" value="<?php echo $total_price; ?>"/>
							...
							<div class="flex-w flex-t bor12 p-b-13">
								...
								<div class="size-209">
									<span class="mtext-110 cl2" id="total_weight">
										<?php echo number_format($total_weight,2)."g"; ?>
									</span>
								</div>
							</div>
							...
							<div class="flex-w flex-t bor12 p-t-15 p-b-30">
								...
								<div class="size-209 p-r-18 p-r-0-sm w-full-ssm" style="height: 30px; margin-bottom: 5px; padding-bottom: 10px;">
										...
										<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
											<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="number" name="contact" placeholder="Add Mobile">
											<div class="dropDownSelect2"></div>
										</div>
							...
							<div class="flex-w flex-t bor12 p-t-15 p-b-13">
								...
								<div class="size-209">
									<span class="mtext-110 cl2" id="total_price">
										...
										<!-- pass the variable to the reciept -->
										<input type="hidden" name="total_price2" value="<?php echo $total_price; ?>">
									</span>
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? <br> Let us know in store at <br> වහලය showroom , 256 Main St , Galle Rd, Rathmalana or call us on 0775891359
					</p>
